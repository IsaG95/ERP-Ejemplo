                ...
                <form class="w-50" name="EditarServicosDrones" method="post">
                    ...
                    <div class="form-row justify-content-center">
                        ...
                        <div class="form-group col-sm-8">
                            ...
                            <label for="inputType">Produto</label>

                            <select id="inputDrone" name="product_id" class="form-control" readonly>
                                <option value="{{ $item[0]['id'] }}" selected> {{ $item[0]['model'] }} - {{ $client[0]['name'] }} (atual) </option>
                            </select>
            ...
            @method('PATCH')
                    ...
                    <div class="form-row justify-content-center">
                        ...
                        <div class="form-group col-sm-8">
                            ...
                            <select id="inputDrone" name="product_id" class="form-control">
                                <option value="{{ $item[0]['id'] }}" selected> {{ $item[0]['model'] }} - {{ $client[0]['name'] }} (atual) </option>

                                @foreach ($products as $product)
                                    <option value="{{ $product->id }}">{{ $product->model }} (<?php
                                        $name = Company::where('id', $product->company_id)->get();
