...
<div class="w-auto d-flex flex-wrap align-items-center" style="background-color: #B22222">
    ...
    <div class="row">
        ...
        <div class="tab-pane fade show active" id="nav-item-01" role="tabpanel">
            ...
            <form name="Services" action="/services/drone" method="POST" enctype="multipart/form-data">

            <input type="hidden" name="company_id" value="{{ $drone->company_id }}">
            <input type="hidden" name="drone_id" value="{{ $drone->id }}">
                ...
                <div class="form-row justify-content-center">
                    ...
                    <div class="form-group col-sm-3">
                        ...
                        <label for="inputParam">Arquivo .param (opcional)</label>

                        <input type="file" name="param" class="form-control" id="inputParam">
                ...
                <div class="form-row justify-content-center">
                    ...
                    <div class="form-group col-sm-2">
                        ...
                        <input type="date" value="{{ $drone->purchase_date }}" class="form-control" id="inputDelivery" name="purchase_date" readonly>
                ...
                <div class="form-row justify-content-center">
                    ...
                    <div class="form-group col-sm-3">
                        ...
                        <textarea placeholder="Ex: Foi trocado a hélice direita superior." name="description" class="form-control" id="inputDescription" rows="4">{{ old('description') }}</textarea>
                    ...
                    <div class="form-group col-sm-3">
                        ...
                        <textarea placeholder="Ex: Hélice trocada era a última do estoque" name="observation" class="form-control" id="inputObservation" rows="4">{{ old('observation') }}</textarea>
