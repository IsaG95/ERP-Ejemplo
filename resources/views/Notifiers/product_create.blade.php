        ...
        <div class="row bg-danger">
            ...
            <div class="col-12 col-bg-6 text-center justify-content-center" style="height: 100vh; padding-top: 11%">
                <center>
                    ...
                    Escolha o produto e digite seu lembrete</h2>

                    <br>
                    <form class="mb-5" method="POST" action="/notifiers">

                        <input type="hidden" value="{{ $company_id }}" name="company_id">
                        <input type="hidden" value="" name="drone_id">

                        <div class="form-row" style="justify-content: center">
                        <div class=" form-group col-sm-4">
                            <select name="product_id" class="form-control" style=" width: 400px" required>
                                <option value="">Escolha o produto que deseja</option>
