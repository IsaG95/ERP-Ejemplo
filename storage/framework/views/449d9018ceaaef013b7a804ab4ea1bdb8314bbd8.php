...
<?php $__env->startSection('title', 'Esqueci minha senha'); ?>
        ...
        <div class="row">
            ...
            <div class="col-6 col-bg-6 text-center bg-secondary" style="height: 100vh; padding-top: 11%">
                <center>
                    ...
                    ?>
                        <h6 style = "color: <?php echo e($color); ?>"> <?php echo e($message[0]['content']); ?> </h6>
...
<?php echo $__env->make('Layout.template-secondary', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xfly-erp\resources\views/Auth/Password/forgot.blade.php ENDPATH**/ ?>