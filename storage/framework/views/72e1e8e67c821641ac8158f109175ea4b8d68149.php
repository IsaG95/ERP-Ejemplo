        ...
        <div class="collapse navbar-collapse" id="navbarSite">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    ...
                    <?php if(Auth::check()): ?>
                        <a class="nav-link" href="/users/<?php echo e(Auth::user()->id); ?>/edit">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Bem-vindo, <?php echo e(strstr(Auth::user()->name, " ", true)); ?>
...
<?php /**PATH C:\laragon\www\xfly-erp\resources\views/Layout/template-secondary.blade.php ENDPATH**/ ?>