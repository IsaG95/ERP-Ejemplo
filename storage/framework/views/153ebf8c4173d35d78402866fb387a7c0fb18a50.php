...
<div class="tab-content" id="myTabContent">
    ...
    <div class="row justify-content-sm-center">
        ...
        <?php for($i = 0; $i < count($companies); $i++): ?>
            ...
            <div class="col-sm-3 col-md-3 mb-4">
                ...
                <div style="height:500px;" class ="card  border-secondary">
                    ...
                    <img class="card-img-top" style="width:auto; height: 200px;"src="/storage/companies_images/<?php echo e($companies[$i]['avatar']); ?>">

                    <div class="card-body">

                        <h4 class="card-title"><?php echo e($companies[$i]['name']); ?></h4>
                        <h6 class="card-subtitle mb-2 text-muted"></h6>

                        <p class="card-text"> <i> <?php echo e($companies[$i]['cnpj']); ?> </i> </p>
                        <p class="card-text"> <?php echo e($companies[$i]['email']); ?> </p>

                        <div class="card-body justify-content-center">

                        <a href="/companies/<?php echo e($companies[$i]['id']); ?>/edit" class="card-link">Editar empresa</a>
                        <br>
                        <a href="/companies/<?php echo e($companies[$i]['id']); ?>/drones" class="card-link">Ver drones</a>
                        <br>
                        <a href="/companies/<?php echo e($companies[$i]['id']); ?>/products" class="card-link">Ver outros produtos</a>
     ...
     <div class="row justify-content-sm-center">
        ...
        <?php for($i = 0; $i < count($notifiers); $i++): ?>
            ...
            <div class=" card-deck col-sm-3 col-md-3 mb-4">
                <br>
                <div  class ="card <?php echo e($color); ?> border-secondary">

                    <div class="card-body text-dark">

                        <h4 class="card-title"><?php echo e($companyName[0]['name']); ?> - <?php echo e($model[0]['model']); ?> <?php echo e($model[0]['key']); ?></h4>

                        <p class="card-text"> <i> <?php echo e($notifiers[$i]['description']); ?> </i> </p>

                        <div class="card-body justify-content-center">

                            <a href="/notifiers/<?php echo e($notifiers[$i]['id']); ?>/<?php echo e($route); ?>"> Editar </a>

                            <a href="/notifiers/confirm/<?php echo e($notifiers[$i]['id']); ?>">
...
<?php echo $__env->make('Layout.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xfly-erp\resources\views/welcome.blade.php ENDPATH**/ ?>