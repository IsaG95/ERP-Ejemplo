  ...
  <?php $__env->startSection('title', 'Cadastros'); ?>
          ...
          <div class="tab-content" id="nav-pills-content">
            ...
            <form name="Companies" action="/companies" method="POST" enctype="multipart/form-data">
                <div class="form-row justify-content-center">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" value="<?php echo e(old('real_name')); ?>" placeholder="Ex: Empresa Fantasia LTDA." class="form-control" id="inputRS" name="real_name" required>
                ...
                <div class="form-row justify-content-center">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" value="<?php echo e(old('name')); ?>" placeholder="Ex: Empresa Fantasia" class="form-control" id="inputNameF" name="name" required>
                ...
                <div class="form-row justify-content-center">
                    ...
                    <div class="form-group col-sm-3">
                        ...
                        <input type="text" value="<?php echo e(old('state_registration')); ?>" data-mask="000.000.000.000" onkeypress="return onlynumber();"
                    ...
                    <div class="form-group col-sm-3">
                        ...
                        <input type="text" value="<?php echo e(old('municipal_registration')); ?>" data-mask="000.000.00.00" onkeypress="return onlynumber();"
                ...
                <div class="form-row justify-content-center">
                    ...
                    <div class="form-group col-sm-3">
                        ...
                        <input type="text" value="<?php echo e(old('cnpj')); ?>" name="cnpj" class="form-control" id="inputCnpj"
                    ...
                    <div class="form-group col-sm-3">
                        ...
                        <input type="text" value="<?php echo e(old('owner')); ?>" name="owner" class="form-control" placeholder="Ex: João da Silva" required>
                ...
                <div class="form-row justify-content-center">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="email" value="<?php echo e(old('email')); ?>" name="email" class="form-control" id="inputEmailC" placeholder="Ex: empresa@gmail.com" required>
                ...
                <div class="form-row justify-content-center">
                    ...
                    <div class="form-group col-sm-3">
                        ...
                        <input type="text" value="<?php echo e(old('contacts[0][name]')); ?>" name="contacts[0][name]" class="form-control" id="inputNomeCt" placeholder="Ex: Ricardo Gomes" required>
                    ...
                    <div class="form-group col-sm-3">
                        ...
                        <input type="email" value="<?php echo e(old('contacts[0][email]')); ?>" name="contacts[0][email]" class="form-control" id="inputEmailCt" placeholder="Ex: responsavel@gmail.com" required>
                ...
                <div class="form-row justify-content-center">
                    ...
                    <div class="form-group col-sm-3">
                        ...
                        <input type="text" value="<?php echo e(old('contacts[0][department]')); ?>" name="contacts[0][department]" class="form-control" id="inputDepartmentCt" placeholder="Ex: Vendas" required>
                    ...
                    <div class="form-group col-sm-3">
                        ...
                        class="form-control telefone" value="<?php echo e(old('contacts[0][number]')); ?>" name="contacts[0][number]" data-mask="(00)00000-0000"  id="inputNumberCt" placeholder="Ex: (14) 99999-9999" required>
                 ...
                 <div class="form-row justify-content-center">
                     ...
                     <div class="form-group col-sm-2">
                         ...
                         value="<?php echo e(old('addresses[0][zipcode]')); ?>" name="addresses[0][zipcode]" class="form-control" id="inputZipcodeA" placeholder="Ex: 11111-111" required>
                     ...
                     <div class="form-group col-sm-4">
                         ...
                         <input type="text" value="<?php echo e(old('addresses[0][street]')); ?>" name="addresses[0][street]" class="form-control" id="inputStreetA" placeholder="Ex: Rua: Feliz da Vida, 10-21" required>
                 ...
                 <div class="form-row justify-content-center">
                     ...
                     <div class="form-group col-sm-6">
                         ...
                         <input type="text" value="<?php echo e(old('addresses[0][complement]')); ?>" name="addresses[0][complement]" class="form-control" id="inputComplementA" placeholder=" Ex: Vila Europa" required>
                 ...
                 <div class="form-row justify-content-center">
                     ...
                     <div class="form-group col-sm-2">
                         ...
                         <input type="text" value="<?php echo e(old('addresses[0][city]')); ?>" name="addresses[0][city]" class="form-control" id="inputCityA" placeholder="Ex: Bauru" required>
                     ...
                     <div class="form-group col-sm-2">
                        ...
                        <input type="text" value="<?php echo e(old('addresses[0][state]')); ?>" name="addresses[0][state]" class="form-control" id="inputStateA" placeholder="Ex: São Paulo" required>
                     ...
                     <div class="form-group col-sm-2">
                         ...
                         <select value="<?php echo e(old('addresses[0][country]')); ?>" name="addresses[0][country]"
            ...
            <div class="form-row justify-content-center">
                ...
                <div class="form-group mr-2 col-sm-3">
                    ...
                    <input type="date" value="<?php echo e($today); ?>" class="form-control" id="input" name="purchase_date" required>
             ...
             <form name="Products" action="/products" enctype="multipart/form-data" method="POST">
                ...
                <div class="form-row justify-content-center">
                    ...
                    <div class="form-group ml-2 col-sm-3">
                        ...
                        <input type="text" value="<?php echo e(old('model')); ?>" name="model" class="form-control" id="inputModelP" placeholder="Ex: Drone de rega" required>
                    ...
                    <div class="form-row justify-content-center">
                        ...
                        <div class="form-group mr-2 col-sm-2">
                            ...
                            <div class="form-group left-inner-addon">
                                ...
                                value="<?php echo e(old('price')); ?>" placeholder="R$00,00" class="form-control"
                    ...
                    <div class="form-row justify-content-center">
                        ...
                        <div class="form-group ml-2 col-sm-3">
                            ...
                            <div class="form-group left-inner-addon">
                                ...
                                <input type="date" value="<?php echo e($today); ?>" name="purchase_date" class="form-control" id="inputPurchaseDate" required>
...
<?php echo $__env->make('Layout.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xfly-erp\resources\views/registers.blade.php ENDPATH**/ ?>